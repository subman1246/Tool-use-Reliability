...
exclude zero, confirming that argument-value propagation is real and measurable even
without routing; the linear arm is therefore a bound on the selection dependency's
